...
const userRoute = require("../express-backend-1/routes/user.route");
const accountRoute = require("../express-backend-1/routes/account.route");
const notifyRoute = require("../express-backend-1/routes/notify.route");
...
host.use(Logger.loggerErrorMiddleware);
// host.use(Jwt.verifyToken, Jwt.verifyRequestMiddleware);

host.use("/users", userRoute);
host.use("/api/accounts", accountRoute);
host.use("/api/notifies", notifyRoute);
